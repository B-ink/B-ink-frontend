      ...
      <div id="risk-form" style="width: 100%">
        <swiper :options="swiperOption" style="height: 100%; width: 100%">
          <swiper-slide style="height: 100%">
            ...
            <img id="nextIcon" src="../../static/icon/下移.png" width="40px" style="position: absolute; bottom: 0px">
          </swiper-slide>
          <swiper-slide style="height: 100%">
            <el-form>
              <el-form-item style="margin-bottom: 10px">
                <img src="../../static/icon/漏水.png" width="20px">浸水评估
              </el-form-item>
              ...
              <el-form-item style="margin-bottom: 10px; margin-top: 20px">
                <img src="../../static/icon/地震.png" width="20px">地震评估
              </el-form-item>
              ...
              <el-form-item style="margin-bottom: 10px; margin-top: 20px">
                <img src="../../static/icon/火灾.png" width="20px">火灾评估
              </el-form-item>
